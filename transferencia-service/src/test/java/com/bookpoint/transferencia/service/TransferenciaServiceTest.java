...
public class TransferenciaServiceTest {
    ...
    void testListarTransferencias() {
        List<Transferencia> lista = Arrays.asList(new Transferencia(1L, 1L, 1L, 1L, 5, "estado", java.time.LocalDate.now()));
    ...
    // ══════════════════════════════════════════════════════════════════
    // TODO: IMPLEMENTAR EN VIVO - testEliminarTransferencia
    // Dificultad: ⭐ (FACIL) — Ver PRUEBAS_PARA_MEMORIZAR.md
    // Pasos:
    //   1. doNothing().when(transferenciaRepository).deleteById(1L);
    //   2. transferenciaService.eliminarTransferencia(1L);
    //   3. verify(transferenciaRepository).deleteById(1L);
    // ══════════════════════════════════════════════════════════════════
    @Test
