...
public class InventarioControllerTest {
    ...
    void testListarTodos() throws Exception {
        InventarioDTO dto = new InventarioDTO(1L, 1L, 1L, 5, 5);
        Mockito.when(inventarioService.listarInventarios()).thenReturn(Arrays.asList(new Inventario(1L, 1L, 1L, 5, 5)));
        Mockito.when(inventarioService.listarInventarios()).thenReturn(Arrays.asList(new Inventario(1L, 1L, 1L, 5, 5)));
    ...
    void testActualizar() throws Exception {
        Inventario actualizado = new Inventario(1L, 1L, 1L, 5, 5);
        ...
        mockMvc.perform(put("/api/v1/inventario/1").contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(new InventarioDTO(1L, 1L, 1L, 5, 5))))
